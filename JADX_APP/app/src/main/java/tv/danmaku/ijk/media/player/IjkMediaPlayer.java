...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    static class C15921 implements IjkLibLoader {
        C15921() {
        }
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m6780w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m6780w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaPlayer == null || ijkMediaPlayer.mNativeMediaPlayer == 0) {
                DebugLog.m6780w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
            }
            switch (message.what) {
                case 0:
                    break;
                ...
                case 100:
                    DebugLog.m6774e(IjkMediaPlayer.TAG, "Error (" + message.arg1 + "," + message.arg2 + ")");
                ...
                case 200:
                    switch (message.arg1) {
                        case 3:
                            DebugLog.m6776i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                            break;
                    }
                ...
                case 10001:
                    ...
                    break;
                default:
                    DebugLog.m6774e(IjkMediaPlayer.TAG, "Unknown message type " + message.what);
                    break;
            }
        }
    }
    ...
    public static class DefaultMediaCodecSelector implements OnMediaCodecSelectListener {
        ...
        public String onMediaCodecSelect(IMediaPlayer iMediaPlayer, String str, int i, int i2) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && !TextUtils.isEmpty(str)) {
                        ...
                        for (String str2 : supportedTypes) {
                            if (!TextUtils.isEmpty(str2)) {
                                ...
                                if (str2.equalsIgnoreCase(str) && (ijkMediaCodecInfo2 = IjkMediaCodecInfo.setupCandidate(codecInfoAt, str)) != null) {
                                    ...
                                    Log.i(IjkMediaPlayer.TAG, String.format(Locale.US, "candidate codec: %s rank=%d", codecInfoAt.getName(), Integer.valueOf(ijkMediaCodecInfo2.mRank)));
                ...
                Log.i(IjkMediaPlayer.TAG, String.format(Locale.US, "selected codec: %s rank=%d", ijkMediaCodecInfo.mCodecInfo.getName(), Integer.valueOf(ijkMediaCodecInfo.mRank)));
