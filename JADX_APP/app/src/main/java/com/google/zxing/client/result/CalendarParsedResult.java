...
public final class CalendarParsedResult extends ParsedResult {
    ...
    private static final long[] RFC2445_DURATION_FIELD_UNITS = {604800000, 86400000, 3600000, HlsChunkSource.DEFAULT_PLAYLIST_BLACKLIST_MS, 1000};
            ...
            if (matcher.matches()) {
                ...
                for (int i = 0; i < RFC2445_DURATION_FIELD_UNITS.length; i++) {
                    if (matcher.group(i + 1) != null) {
                        j += Integer.parseInt(r4) * RFC2445_DURATION_FIELD_UNITS[i];
                    }
                }
            }
        }
