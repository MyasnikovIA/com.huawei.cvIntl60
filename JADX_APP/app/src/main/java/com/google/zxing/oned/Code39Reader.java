...
public final class Code39Reader extends OneDReader {
    ...
    static {
        int[] iArr = {52, 289, 97, 352, 49, HttpStatusCodes.STATUS_CODE_NOT_MODIFIED, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, 193, 448, 145, 400, 208, 133, 388, 196, 148, 168, 162, 138, 42};
    ...
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) {
        ...
        while (true) {
            ...
            if (patternToChar == '*') {
                ...
                return new Result(sb, null, new ResultPoint[]{new ResultPoint((r6[1] + r6[0]) / 2.0f, i), new ResultPoint(nextSet + (i4 / 2.0f), i)}, BarcodeFormat.CODE_39);
            }
            nextSet = nextSet2;
        }
    }
