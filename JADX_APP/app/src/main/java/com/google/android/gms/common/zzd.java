...
class zzd {
    ...
    /* renamed from: wU */
    private static zzu f6471wU;

    /* renamed from: wV */
    private static Context f6472wV;
    ...
    static abstract class zza extends zzr.zza {
        ...
        protected zza(byte[] bArr) {
            ...
            this.f6473wW = Arrays.hashCode(bArr);
        }
    ...
    static abstract class zzc extends zza {
        ...
        /* renamed from: wZ */
        private static final WeakReference<byte[]> f6475wZ = new WeakReference<>(null);

        /* renamed from: wY */
        private WeakReference<byte[]> f6476wY;

        zzc(byte[] bArr) {
            super(bArr);
            this.f6476wY = f6475wZ;
        }
        ...
        byte[] getBytes() {
            byte[] bArr;
            synchronized (this) {
                bArr = this.f6476wY.get();
                if (bArr == null) {
                    bArr = zzaqp();
                    this.f6476wY = new WeakReference<>(bArr);
                }
            }
            return bArr;
        }
    ...
    /* renamed from: com.google.android.gms.common.zzd$zzd */
    static final class C1889zzd {

        /* renamed from: xa */
        static final zza[] f6477xa = {new zzc(zza.zzhg("0\u0082\u0004C0\u0082\u0003+ \u0003\u0002\u0001\u0002\u0002\t\u0000Âà\u0087FdJ0\u008d0")) { // from class: com.google.android.gms.common.zzd.zzd.1
            BinderC12641(byte[] bArr) {
                super(bArr);
            }
        ...
        final class BinderC12641 extends zzc {
            BinderC12641(byte[] bArr) {
                super(bArr);
            }
        ...
        final class BinderC12652 extends zzc {
            BinderC12652(byte[] bArr) {
                super(bArr);
            }
    ...
    static boolean zza(String str, zza zzaVar) {
        if (f6471wU == null && !zzaqm()) {
            return false;
        }
        try {
            return f6471wU.zzd(str, zzaVar.zzaqn());
        } catch (RemoteException e) {
    ...
    private static synchronized boolean zzaqm() {
        ...
        synchronized (zzd.class) {
            if (f6471wU == null) {
                ...
                if (f6471wU == null) {
                    try {
                        zztl zza2 = zztl.zza(f6472wV, zztl.f6905Qq, "com.google.android.gms.googlecertificates");
                        Log.d("GoogleCertificates", "com.google.android.gms.googlecertificates module is loaded");
                        f6471wU = zzu.zza.zzdv(zza2.zzjd("com.google.android.gms.common.GoogleCertificatesImpl"));
                    } catch (zztl.zza e) {
    ...
    static boolean zzb(String str, zza zzaVar) {
        ...
        try {
            return f6471wU.zze(str, zzaVar.zzaqn());
        } catch (RemoteException e) {
    ...
    static synchronized void zzbo(Context context) {
        synchronized (zzd.class) {
            if (f6472wV != null) {
                ...
                f6472wV = context.getApplicationContext();
            }
        }
    }
}
