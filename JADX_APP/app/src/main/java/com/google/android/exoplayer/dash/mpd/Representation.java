...
public abstract class Representation implements FormatWrapper {
    ...
    /* synthetic */ Representation(String str, long j, Format format, SegmentBase segmentBase, String str2, C11941 c11941) {
    ...
    private Representation(String str, long j, Format format, SegmentBase segmentBase, String str2) {
        ...
        this.revisionId = j;
        this.format = format;
        this.cacheKey = str2 == null ? str + "." + format.f5934id + "." + j : str2;
    ...
    public static class SingleSegmentRepresentation extends Representation {
        ...
        public SingleSegmentRepresentation(String str, long j, Format format, SegmentBase.SingleSegmentBase singleSegmentBase, String str2, long j2) {
            ...
            this.segmentIndex = this.indexUri != null ? null : new DashSingleSegmentIndex(new RangedUri(singleSegmentBase.uri, null, 0L, j2));
        }
