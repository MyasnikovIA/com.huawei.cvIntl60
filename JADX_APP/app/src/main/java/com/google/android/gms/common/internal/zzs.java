...
public interface zzs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzs {
        ...
        /* renamed from: com.google.android.gms.common.internal.zzs$zza$zza */
        private static class C1883zza implements zzs {
            private IBinder zzajq;

            C1883zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
        ...
        public static zzs zzdt(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.IGmsCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzs)) ? new C1883zza(iBinder) : (zzs) queryLocalInterface;
        }
