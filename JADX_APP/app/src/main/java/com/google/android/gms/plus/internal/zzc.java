...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        /* renamed from: com.google.android.gms.plus.internal.zzc$zza$zza */
        private static class C1915zza implements zzc {
            private IBinder zzajq;

            C1915zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
        ...
        public static zzc zzkl(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.plus.internal.IPlusOneButtonCreator");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzc)) ? new C1915zza(iBinder) : (zzc) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    com.google.android.gms.dynamic.zzd zza = zza(zzd.zza.zzfd(parcel.readStrongBinder()), parcel.readInt(), parcel.readInt(), parcel.readString(), parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zza != null ? zza.asBinder() : null);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.plus.internal.IPlusOneButtonCreator");
                    com.google.android.gms.dynamic.zzd zza2 = zza(zzd.zza.zzfd(parcel.readStrongBinder()), parcel.readInt(), parcel.readInt(), parcel.readString(), parcel.readString());
                    parcel2.writeNoException();
