...
public interface zzss extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzss {
        ...
        /* renamed from: com.google.android.gms.internal.zzss$zza$zza */
        private static class C1906zza implements zzss {
            private IBinder zzajq;

            C1906zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
        ...
        public static zzss zzea(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzss)) ? new C1906zza(iBinder) : (zzss) queryLocalInterface;
        }
