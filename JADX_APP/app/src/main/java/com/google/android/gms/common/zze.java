...
public class zze {
    ...
    /* renamed from: xb */
    public static boolean f6478xb = false;

    /* renamed from: xc */
    public static boolean f6479xc = false;

    /* renamed from: xd */
    static boolean f6480xd = false;

    /* renamed from: xe */
    private static boolean f6481xe = false;

    /* renamed from: xf */
    static final AtomicBoolean f6482xf = new AtomicBoolean();

    /* renamed from: xg */
    private static final AtomicBoolean f6483xg = new AtomicBoolean();
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C1228R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        try {
            ...
            if (z) {
                zzd.zza zza = zzbv.zza(packageInfo, zzd.C1889zzd.f6477xa);
                if (zza == null) {
            ...
            } else if (zzbv.zza(packageInfo2, zzd.C1889zzd.f6477xa) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
    ...
    private static void zzbu(Context context) {
        try {
            ...
            if (packageInfo == null || zzf.zzbv(context).zza(packageInfo, zzd.C1889zzd.f6477xa[1]) == null) {
                f6480xd = false;
            } else {
                f6480xd = true;
            }
