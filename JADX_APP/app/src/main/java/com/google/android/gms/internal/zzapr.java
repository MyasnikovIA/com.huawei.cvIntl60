    ...
    public static Type zza(Type type, Class<?> cls, Type type2) {
        ...
        do {
            ...
            if (!(type3 instanceof TypeVariable)) {
                ...
                boolean z2 = zza6 != ownerType;
                Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
                int length = actualTypeArguments.length;
                int i = 0;
                boolean z3 = z2;
                while (i < length) {
                    Type zza7 = zza(type, cls, actualTypeArguments[i]);
                    if (zza7 != actualTypeArguments[i]) {
                        if (z3) {
                ...
                return z3 ? zza(zza6, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
            }
