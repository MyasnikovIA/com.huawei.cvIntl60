...
public interface zzrl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzrl {
        ...
        /* renamed from: com.google.android.gms.internal.zzrl$zza$zza */
        private static class C1903zza implements zzrl {
            private IBinder zzajq;

            C1903zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
        ...
        public static zzrl zzdp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzrl)) ? new C1903zza(iBinder) : (zzrl) queryLocalInterface;
        }
