...
public interface zznw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznw {
        ...
        /* renamed from: com.google.android.gms.internal.zznw$zza$zza */
        private static class C1900zza implements zznw {
            private IBinder zzajq;

            C1900zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
            ...
            public void zza(Account account, int i, zznv zznvVar) {
        ...
        public static zznw zzcd(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznw)) ? new C1900zza(iBinder) : (zznw) queryLocalInterface;
        }
    ...
    void zza(Account account, int i, zznv zznvVar);
}
