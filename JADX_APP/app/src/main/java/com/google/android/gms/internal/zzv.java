...
public class zzv implements com.google.android.gms.internal.zzb {
    ...
    private static class zzb extends FilterInputStream {
        ...
        /* synthetic */ zzb(InputStream inputStream, C14071 c14071) {
            this(inputStream);
        }
    ...
    static String zzd(InputStream inputStream) {
        return new String(zza(inputStream, (int) zzc(inputStream)), C1167C.UTF8_NAME);
    }
