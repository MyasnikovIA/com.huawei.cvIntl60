...
public abstract class SegmentBase {
    ...
    public long getPresentationTimeOffsetUs() {
        return Util.scaleLargeTimestamp(this.presentationTimeOffset, C1167C.MICROS_PER_SECOND, this.timescale);
    }
    ...
    public static abstract class MultiSegmentBase extends SegmentBase {
        ...
        public int getSegmentNum(long j, long j2) {
            ...
            if (this.segmentTimeline == null) {
                int i = ((int) (j / ((this.duration * C1167C.MICROS_PER_SECOND) / this.timescale))) + this.startNumber;
        ...
        public final long getSegmentDurationUs(int i, long j) {
            if (this.segmentTimeline != null) {
                return (this.segmentTimeline.get(i - this.startNumber).duration * C1167C.MICROS_PER_SECOND) / this.timescale;
            }
            return i == getLastSegmentNum(j) ? j - getSegmentTimeUs(i) : (this.duration * C1167C.MICROS_PER_SECOND) / this.timescale;
        }
        ...
        public final long getSegmentTimeUs(int i) {
            ...
            return Util.scaleLargeTimestamp(j, C1167C.MICROS_PER_SECOND, this.timescale);
        }
    ...
    public static class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            return new RangedUri(this.baseUrl, this.initializationTemplate.buildUri(representation.format.f5934id, 0, representation.format.bitrate, 0L), 0L, -1L);
        }
        ...
        public RangedUri getSegmentUrl(Representation representation, int i) {
            ...
            return new RangedUri(this.baseUrl, this.mediaTemplate.buildUri(representation.format.f5934id, i, representation.format.bitrate, j), 0L, -1L);
        }
        ...
        public int getLastSegmentNum(long j) {
            ...
            long j2 = (this.duration * C1167C.MICROS_PER_SECOND) / this.timescale;
