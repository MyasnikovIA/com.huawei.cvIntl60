...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        /* renamed from: com.google.android.gms.plus.internal.zzb$zza$zza */
        private static class C1914zza implements zzb {
            private IBinder zzajq;

            C1914zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
            ...
            @Override // com.google.android.gms.plus.internal.zzb
            public void zzea(Status status) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.plus.internal.IPlusCallbacks");
        ...
        public static zzb zzkk(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzb)) ? new C1914zza(iBinder) : (zzb) queryLocalInterface;
        }
    ...
    void zzea(Status status);

    void zzk(int i, Bundle bundle);

    void zznq(String str);

    void zznr(String str);
}
