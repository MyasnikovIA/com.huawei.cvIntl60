...
public interface zzj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzj {
        ...
        /* renamed from: com.google.android.gms.auth.api.credentials.internal.zzj$zza$zza */
        private static class C1874zza implements zzj {
            private IBinder zzajq;

            C1874zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
        ...
        public static zzj zzcf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzj)) ? new C1874zza(iBinder) : (zzj) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case 3:
                    parcel.enforceInterface("com.google.android.gms.auth.api.credentials.internal.ICredentialsCallbacks");
                    zza(parcel.readInt() != 0 ? Status.CREATOR.createFromParcel(parcel) : null, parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
