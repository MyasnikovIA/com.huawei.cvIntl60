...
public class Flag extends AbstractSafeParcelable implements Comparable<Flag> {
    ...
    private static final Charset UTF_8 = Charset.forName(C1167C.UTF8_NAME);
    public static final zza aAA = new zza();

    /* renamed from: Fe */
    final String f6930Fe;
    final long aAw;
    final byte[] aAx;
    ...
    public boolean equals(Object obj) {
        ...
        switch (this.aAy) {
            ...
            case 4:
                return zzz.equal(this.f6930Fe, flag.f6930Fe);
            case 5:
    ...
    public int compareTo(Flag flag) {
        ...
        switch (this.aAy) {
            ...
            case 4:
                return compare(this.f6930Fe, flag.f6930Fe);
            case 5:
