...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static class C14881 implements Comparator<Comparable> {
        C14881() {
        }
    ...
    private abstract class LinkedTreeMapIterator<T> implements Iterator<T> {
        ...
        /* synthetic */ LinkedTreeMapIterator(LinkedHashTreeMap linkedHashTreeMap, C14881 c14881) {
            this();
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        class C14891 extends LinkedHashTreeMap<K, V>.LinkedTreeMapIterator<Map.Entry<K, V>> {
            C14891() {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C14901 extends LinkedHashTreeMap<K, V>.LinkedTreeMapIterator<K> {
            C14901() {
                LinkedHashTreeMap linkedHashTreeMap = LinkedHashTreeMap.this;
            }
