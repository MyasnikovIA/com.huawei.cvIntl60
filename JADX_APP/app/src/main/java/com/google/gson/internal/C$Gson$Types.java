        ...
        do {
            ...
            if (!(type3 instanceof TypeVariable)) {
                ...
                if (type3 instanceof ParameterizedType) {
                    ...
                    return z3 ? newParameterizedTypeWithOwner(resolve4, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
                }
                if (type3 instanceof WildcardType) {
                    ...
                    if (upperBounds.length == 1 && (resolve = resolve(type, cls, upperBounds[0])) != upperBounds[0]) {
