...
public class HttpHeaders extends GenericData {
    ...
    public HttpHeaders setBasicAuthentication(String str, String str2) {
        ...
        String valueOf2 = String.valueOf(String.valueOf((String) Preconditions.checkNotNull(str2)));
    ...
    private static String toStringValue(Object obj) {
        return obj instanceof Enum ? FieldInfo.m6682of((Enum<?>) obj).getName() : obj.toString();
    }

    static void serializeHeaders(HttpHeaders httpHeaders, StringBuilder sb, StringBuilder sb2, Logger logger, LowLevelHttpRequest lowLevelHttpRequest) {
    ...
    static void serializeHeaders(HttpHeaders httpHeaders, StringBuilder sb, StringBuilder sb2, Logger logger, LowLevelHttpRequest lowLevelHttpRequest, Writer writer) {
    ...
    private static final class ParseHeaderState {
        ...
        public ParseHeaderState(HttpHeaders httpHeaders, StringBuilder sb) {
            ...
            this.classInfo = ClassInfo.m6681of(cls, true);
            this.logger = sb;
    ...
    void parseHeader(String str, String str2, ParseHeaderState parseHeaderState) {
        ...
        if (sb != null) {
            ...
            sb.append(new StringBuilder(valueOf.length() + 2 + valueOf2.length()).append(valueOf).append(": ").append(valueOf2).toString()).append(StringUtils.LINE_SEPARATOR);
        }
