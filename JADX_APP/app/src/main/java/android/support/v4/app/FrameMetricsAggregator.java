...
public class FrameMetricsAggregator {
    ...
    private static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        Window.OnFrameMetricsAvailableListener mListener = new Window.OnFrameMetricsAvailableListener() { // from class: android.support.v4.app.FrameMetricsAggregator.FrameMetricsApi24Impl.1
            WindowOnFrameMetricsAvailableListenerC03681() {
            }
        ...
        class WindowOnFrameMetricsAvailableListenerC03681 implements Window.OnFrameMetricsAvailableListener {
            WindowOnFrameMetricsAvailableListenerC03681() {
            }
        ...
        void addDurationItem(SparseIntArray sparseIntArray, long j) {
            if (sparseIntArray != null) {
                int i = (int) ((500000 + j) / C1167C.MICROS_PER_SECOND);
                if (j >= 0) {
