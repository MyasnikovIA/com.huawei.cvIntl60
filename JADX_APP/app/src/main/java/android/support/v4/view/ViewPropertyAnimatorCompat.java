...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m2451x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m2452y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m2453z(float f) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            view.animate().z(f);
        }
    ...
    class C04651 extends AnimatorListenerAdapter {
        ...
        C04651(ViewPropertyAnimatorListener viewPropertyAnimatorListener, View view) {
            viewPropertyAnimatorListener = viewPropertyAnimatorListener;
            view = view;
        }
    ...
    private void setListenerInternal(View view, ViewPropertyAnimatorListener viewPropertyAnimatorListener) {
        if (viewPropertyAnimatorListener != null) {
            view.animate().setListener(new AnimatorListenerAdapter() { // from class: android.support.v4.view.ViewPropertyAnimatorCompat.1
                ...
                C04651(ViewPropertyAnimatorListener viewPropertyAnimatorListener2, View view2) {
    ...
    public ViewPropertyAnimatorCompat setUpdateListener(ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener) {
        ...
        if (view != null && Build.VERSION.SDK_INT >= 19) {
            ...
            if (viewPropertyAnimatorUpdateListener != null) {
                c04662 = new ValueAnimator.AnimatorUpdateListener() { // from class: android.support.v4.view.ViewPropertyAnimatorCompat.2
                    final /* synthetic */ ViewPropertyAnimatorUpdateListener val$listener;
                    final /* synthetic */ View val$view;

                    C04662(ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener2, View view2) {
            ...
            view2.animate().setUpdateListener(c04662);
        }
        return this;
    }

    /* renamed from: android.support.v4.view.ViewPropertyAnimatorCompat$2 */
    class C04662 implements ValueAnimator.AnimatorUpdateListener {
        final /* synthetic */ ViewPropertyAnimatorUpdateListener val$listener;
        final /* synthetic */ View val$view;
