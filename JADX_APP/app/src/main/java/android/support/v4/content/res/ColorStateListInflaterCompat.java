...
public final class ColorStateListInflaterCompat {
    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                ...
                int[][] iArr4 = (int[][]) GrowingArrayUtils.append(iArr, i2, trimStateSet);
                i2++;
                iArr = iArr4;
            }
        }
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i, @FloatRange(from = 0.0d, m1353to = 1.0d) float f) {
