...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public long getCurrentPosition(Long l) {
        return Math.max(0L, ((long) ((l != null ? l.longValue() : SystemClock.elapsedRealtime() - this.mUpdateTime) * this.mSpeed)) + this.mPosition);
    }
    ...
    static class C04371 implements Parcelable.Creator<PlaybackStateCompat> {
        C04371() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        static class C04381 implements Parcelable.Creator<CustomAction> {
            C04381() {
            }
