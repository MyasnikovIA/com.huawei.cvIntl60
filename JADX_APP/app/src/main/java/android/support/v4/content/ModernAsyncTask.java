...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class ThreadFactoryC03731 implements ThreadFactory {
        private final AtomicInteger mCount = new AtomicInteger(1);
    ...
    class C03742 extends WorkerRunnable<Params, Result> {
        C03742() {
        }
    ...
    class C03753 extends FutureTask<Result> {
        C03753(Callable callable) {
            super(callable);
        }
