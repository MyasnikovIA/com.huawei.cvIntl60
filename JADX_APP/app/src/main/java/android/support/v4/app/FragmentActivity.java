...
public class FragmentActivity extends SupportActivity implements InterfaceC0150q, ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private C0149p mViewModelStore;
    ...
    class HandlerC03481 extends Handler {
        HandlerC03481() {
        }
    ...
    @Override // android.support.v4.app.SupportActivity, android.arch.lifecycle.InterfaceC0138e
    ...
    private void markFragmentsCreated() {
        while (markState(getSupportFragmentManager(), AbstractC0136c.b.CREATED)) {
        }
    }

    private static boolean markState(FragmentManager fragmentManager, AbstractC0136c.b bVar) {
        boolean z = false;
        for (Fragment fragment : fragmentManager.getFragments()) {
            if (fragment != null) {
                if (fragment.getLifecycle().mo1311a().m1314a(AbstractC0136c.b.STARTED)) {
                    fragment.mLifecycleRegistry.m1328a(bVar);
                    z = true;
                }
                FragmentManager peekChildFragmentManager = fragment.peekChildFragmentManager();
                z = peekChildFragmentManager != null ? markState(peekChildFragmentManager, bVar) | z : z;
            }
        }
        return z;
    }
