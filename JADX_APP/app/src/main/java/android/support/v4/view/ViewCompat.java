...
public class ViewCompat {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, m1353to = 1.0d) float f) {
        view.setAlpha(f);
    }
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            if (onApplyWindowInsetsListener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: android.support.v4.view.ViewCompat.1
                    ViewOnApplyWindowInsetsListenerC04591() {
                    }
    ...
    static class ViewOnApplyWindowInsetsListenerC04591 implements View.OnApplyWindowInsetsListener {
        ViewOnApplyWindowInsetsListenerC04591() {
        }
    ...
    static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m2450at(view).preDispatch(keyEvent);
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m2450at(view).dispatch(view, keyEvent);
    }
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m2450at(View view) {
