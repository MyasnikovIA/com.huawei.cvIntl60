...
public final class NotificationManagerCompat {
    ...
    private static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            iNotificationSideChannel.notify(this.packageName, this.f2150id, this.tag, this.notif);
        }

        public String toString() {
            StringBuilder sb = new StringBuilder("NotifyTask[");
            sb.append("packageName:").append(this.packageName);
            sb.append(", id:").append(this.f2150id);
    ...
    private static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f2149id, this.tag);
            }
        }
        ...
        public String toString() {
            ...
            sb.append("packageName:").append(this.packageName);
            sb.append(", id:").append(this.f2149id);
            sb.append(", tag:").append(this.tag);
