...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        ...
        static class C03981 implements Parcelable.Creator<MediaItem> {
            C03981() {
            }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void getItem(@NonNull String str, @NonNull ItemCallback itemCallback) {
            ...
            if (!isConnected()) {
                ...
                this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.3
                    ...
                    RunnableC03923(ItemCallback itemCallback2, String str2) {
            ...
            try {
                ...
                this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.4
                    ...
                    RunnableC03934(ItemCallback itemCallback2, String str2) {
                        itemCallback = itemCallback2;
                        str = str2;
                    }
        ...
        class RunnableC03923 implements Runnable {
            final /* synthetic */ ItemCallback val$cb;
            final /* synthetic */ String val$mediaId;
        ...
        class RunnableC03934 implements Runnable {
            final /* synthetic */ ItemCallback val$cb;
            final /* synthetic */ String val$mediaId;
        ...
        public void search(@NonNull String str, Bundle bundle, @NonNull SearchCallback searchCallback) {
            ...
            try {
                ...
                this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.5
                    ...
                    RunnableC03945(SearchCallback searchCallback2, String str2, Bundle bundle2) {
        ...
        class RunnableC03945 implements Runnable {
            final /* synthetic */ SearchCallback val$callback;
            final /* synthetic */ Bundle val$extras;
            final /* synthetic */ String val$query;
            ...
            try {
                ...
                if (customActionCallback != null) {
                    this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.6
                        ...
                        RunnableC03956(CustomActionCallback customActionCallback2, String str2, Bundle bundle2) {
        ...
        class RunnableC03956 implements Runnable {
            final /* synthetic */ String val$action;
            final /* synthetic */ CustomActionCallback val$callback;
            final /* synthetic */ Bundle val$extras;
        ...
        private class MediaServiceConnection implements ServiceConnection {
            ...
            class RunnableC03961 implements Runnable {
                final /* synthetic */ IBinder val$binder;
                final /* synthetic */ ComponentName val$name;

                RunnableC03961(ComponentName componentName, IBinder iBinder) {
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    ...
                    RunnableC03961(ComponentName componentName2, IBinder iBinder2) {
            ...
            class RunnableC03972 implements Runnable {
                final /* synthetic */ ComponentName val$name;

                RunnableC03972(ComponentName componentName) {
                    componentName = componentName;
                }
            ...
            public void onServiceDisconnected(ComponentName componentName) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.2
                    ...
                    RunnableC03972(ComponentName componentName2) {
                        componentName = componentName2;
                    }
    ...
    static class MediaBrowserImplApi21 implements ConnectionCallback.ConnectionCallbackInternal, MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void getItem(@NonNull String str, @NonNull ItemCallback itemCallback) {
            ...
            if (!MediaBrowserCompatApi21.isConnected(this.mBrowserObj)) {
                ...
                this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplApi21.1
                    ...
                    RunnableC03831(ItemCallback itemCallback2, String str2) {
                        itemCallback = itemCallback2;
                        str = str2;
                    }
                ...
                if (this.mServiceBinderWrapper == null) {
                    this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplApi21.2
                        ...
                        RunnableC03842(ItemCallback itemCallback2, String str2) {
                            itemCallback = itemCallback2;
                            str = str2;
                        }
                ...
                try {
                    ...
                    this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplApi21.3
                        ...
                        RunnableC03853(ItemCallback itemCallback2, String str2) {
                            itemCallback = itemCallback2;
                            str = str2;
                        }
        ...
        class RunnableC03831 implements Runnable {
            final /* synthetic */ ItemCallback val$cb;
            final /* synthetic */ String val$mediaId;
        ...
        class RunnableC03853 implements Runnable {
            final /* synthetic */ ItemCallback val$cb;
            final /* synthetic */ String val$mediaId;
        ...
        public void search(@NonNull String str, Bundle bundle, @NonNull SearchCallback searchCallback) {
            ...
            if (this.mServiceBinderWrapper == null) {
                ...
                this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplApi21.4
                    ...
                    RunnableC03864(SearchCallback searchCallback2, String str2, Bundle bundle2) {
                        searchCallback = searchCallback2;
                        str = str2;
                        bundle = bundle2;
                    }
            ...
            try {
                ...
                Log.i(MediaBrowserCompat.TAG, "Remote error searching items with query: " + str2, e);
                this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplApi21.5
                    final /* synthetic */ SearchCallback val$callback;
                    final /* synthetic */ Bundle val$extras;
                    final /* synthetic */ String val$query;

                    RunnableC03875(SearchCallback searchCallback2, String str2, Bundle bundle2) {
                        searchCallback = searchCallback2;
                        str = str2;
                        bundle = bundle2;
                    }
        ...
        class RunnableC03864 implements Runnable {
            final /* synthetic */ SearchCallback val$callback;
            final /* synthetic */ Bundle val$extras;
            final /* synthetic */ String val$query;
        ...
        class RunnableC03875 implements Runnable {
            final /* synthetic */ SearchCallback val$callback;
            final /* synthetic */ Bundle val$extras;
            final /* synthetic */ String val$query;
            ...
            if (this.mServiceBinderWrapper == null) {
                ...
                if (customActionCallback != null) {
                    this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplApi21.6
                        ...
                        RunnableC03886(CustomActionCallback customActionCallback2, String str2, Bundle bundle2) {
                            customActionCallback = customActionCallback2;
                            str = str2;
                            bundle = bundle2;
                        }
            ...
            try {
                ...
                if (customActionCallback2 != null) {
                    this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplApi21.7
                        ...
                        RunnableC03897(CustomActionCallback customActionCallback2, String str2, Bundle bundle2) {
                            customActionCallback = customActionCallback2;
                            str = str2;
                            bundle = bundle2;
                        }
        ...
        class RunnableC03886 implements Runnable {
            final /* synthetic */ String val$action;
            final /* synthetic */ CustomActionCallback val$callback;
            final /* synthetic */ Bundle val$extras;
        ...
        class RunnableC03897 implements Runnable {
            final /* synthetic */ String val$action;
            final /* synthetic */ CustomActionCallback val$callback;
            final /* synthetic */ Bundle val$extras;
