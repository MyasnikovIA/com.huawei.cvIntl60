...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/transition/q;->a:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/support/transition/q;->b:Z
    ...
    :goto_2
    sput-boolean v1, Landroid/support/transition/q;->c:Z
...
.method private static a(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
    ...
    .line 93
    sget-boolean v0, Landroid/support/transition/q;->a:Z
    ...
    .line 102
    :goto_1
    sget-boolean v4, Landroid/support/transition/q;->b:Z
    ...
    .line 120
    sget-boolean v3, Landroid/support/transition/q;->c:Z
...
.method static a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    .line 53
    invoke-static {p1, v0}, Landroid/support/transition/ad;->a(Landroid/view/View;Landroid/graphics/Matrix;)V

    .line 54
    invoke-static {p0, v0}, Landroid/support/transition/ad;->b(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    .line 64
    invoke-static {p1, v0, v1, p0}, Landroid/support/transition/q;->a(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
