...
.field private e:Landroid/support/v7/widget/bc$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/bc;->j:Landroid/view/animation/Interpolator;
...
.method private a()Z
    ...
    .prologue
    .line 146
    iget-object v0, p0, Landroid/support/v7/widget/bc;->f:Landroid/widget/Spinner;
...
.method private b()V
    ...
    .line 157
    invoke-direct {p0}, Landroid/support/v7/widget/bc;->d()Landroid/widget/Spinner;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/bc;->f:Landroid/widget/Spinner;

    .line 159
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/bc;->b:Landroid/support/v7/widget/aq;
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/bc$a;-><init>(Landroid/support/v7/widget/bc;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bc;->a:Ljava/lang/Runnable;

    .line 169
    :cond_3
    iget-object v0, p0, Landroid/support/v7/widget/bc;->f:Landroid/widget/Spinner;

    iget v1, p0, Landroid/support/v7/widget/bc;->i:I
...
# virtual methods
.method a(Landroid/support/v7/app/a$c;Z)Landroid/support/v7/widget/bc$c;
    .locals 4
    ...
    invoke-direct {v0, p0, v1, p1, p2}, Landroid/support/v7/widget/bc$c;-><init>(Landroid/support/v7/widget/bc;Landroid/content/Context;Landroid/support/v7/app/a$c;Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bc$c;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget v3, p0, Landroid/support/v7/widget/bc;->h:I
    ...
    .line 301
    iget-object v1, p0, Landroid/support/v7/widget/bc;->e:Landroid/support/v7/widget/bc$b;
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/bc$b;-><init>(Landroid/support/v7/widget/bc;)V

    iput-object v1, p0, Landroid/support/v7/widget/bc;->e:Landroid/support/v7/widget/bc$b;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput v0, p0, Landroid/support/v7/widget/bc;->d:I
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 372
    invoke-virtual {p2}, Landroid/support/v7/widget/bc$c;->b()Landroid/support/v7/app/a$c;
...
.method public onMeasure(II)V
    ...
    .line 101
    iget-object v4, p0, Landroid/support/v7/widget/bc;->b:Landroid/support/v7/widget/aq;
    ...
    iput v3, p0, Landroid/support/v7/widget/bc;->c:I

    .line 109
    :goto_1
    iget v3, p0, Landroid/support/v7/widget/bc;->c:I

    iget v4, p0, Landroid/support/v7/widget/bc;->d:I
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/bc;->g:Z
    ...
    .line 120
    iget-object v1, p0, Landroid/support/v7/widget/bc;->b:Landroid/support/v7/widget/aq;
    ...
    .line 136
    iget v0, p0, Landroid/support/v7/widget/bc;->i:I
...
.method public setContentHeight(I)V
    ...
    .prologue
    .line 199
    iput p1, p0, Landroid/support/v7/widget/bc;->h:I
...
.method public setTabSelected(I)V
    ...
    .line 183
    iput p1, p0, Landroid/support/v7/widget/bc;->i:I
