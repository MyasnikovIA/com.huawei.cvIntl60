...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 48
    iput-object p1, p0, Landroid/support/v7/widget/r;->b:Landroid/widget/ProgressBar;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 100
    iget-object v1, p0, Landroid/support/v7/widget/r;->c:Landroid/graphics/Bitmap;

    if-nez v1, :cond_7

    .line 101
    iput-object v0, p0, Landroid/support/v7/widget/r;->c:Landroid/graphics/Bitmap;
...
.method a()Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 145
    iget-object v0, p0, Landroid/support/v7/widget/r;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 52
    iget-object v0, p0, Landroid/support/v7/widget/r;->b:Landroid/widget/ProgressBar;
    ...
    invoke-static {v0, p1, v1, p2, v3}, Landroid/support/v7/widget/bk;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bk;

    move-result-object v0

    .line 55
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/bk;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 57
    iget-object v2, p0, Landroid/support/v7/widget/r;->b:Landroid/widget/ProgressBar;
