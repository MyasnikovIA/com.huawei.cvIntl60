...
.method constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 5033
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$v;->c:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$v;->b:Landroid/view/animation/Interpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$v;->a:Landroid/widget/OverScroller;
...
.method private b(IIII)I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$v;->c:Landroid/support/v7/widget/RecyclerView;
...
.method a()V
    ...
    .line 5174
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$v;->c:Landroid/support/v7/widget/RecyclerView;
...
.method public a(II)V
    ...
    .line 5181
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$v;->e:I

    iput v1, p0, Landroid/support/v7/widget/RecyclerView$v;->d:I

    .line 5182
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$v;->a:Landroid/widget/OverScroller;
...
.method public a(IIILandroid/view/animation/Interpolator;)V
    ...
    .line 5233
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$v;->b:Landroid/view/animation/Interpolator;

    if-eq v0, p4, :cond_0

    .line 5234
    iput-object p4, p0, Landroid/support/v7/widget/RecyclerView$v;->b:Landroid/view/animation/Interpolator;

    .line 5235
    new-instance v0, Landroid/widget/OverScroller;

    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView$v;->c:Landroid/support/v7/widget/RecyclerView;
...
.method public run()V
    ...
    iget-object v2, v0, Landroid/support/v7/widget/RecyclerView$v;->c:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v14, v0, Landroid/support/v7/widget/RecyclerView$v;->a:Landroid/widget/OverScroller;
    ...
    iget-object v5, v2, Landroid/support/v7/widget/RecyclerView;->I:[I
    ...
    iget v2, v0, Landroid/support/v7/widget/RecyclerView$v;->e:I
    ...
    iput v0, v1, Landroid/support/v7/widget/RecyclerView$v;->e:I
    ...
    iget-object v3, v0, Landroid/support/v7/widget/RecyclerView$v;->c:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->J:[I
    ...
    .line 5074
    invoke-virtual {v15}, Landroid/support/v7/widget/RecyclerView$s;->d()Z
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/ao$a;

    invoke-virtual {v2}, Landroid/support/v7/widget/ao$a;->a()V
    ...
    invoke-virtual {v15, v2, v3}, Landroid/support/v7/widget/RecyclerView$s;->a(II)V
    ...
    .line 5078
    :cond_14
    invoke-virtual {v15}, Landroid/support/v7/widget/RecyclerView$s;->e()I
    ...
    invoke-virtual {v15, v2}, Landroid/support/v7/widget/RecyclerView$s;->a(I)V
    ...
    invoke-virtual {v15, v2, v7}, Landroid/support/v7/widget/RecyclerView$s;->a(II)V
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/ao;
    ...
    invoke-virtual {v2, v3, v10, v9}, Landroid/support/v7/widget/ao;->a(Landroid/support/v7/widget/RecyclerView;II)V
