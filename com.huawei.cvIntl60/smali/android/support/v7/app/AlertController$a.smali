...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 909
    iput-boolean v1, p0, Landroid/support/v7/app/AlertController$a;->P:Z
...
.method private b(Landroid/support/v7/app/AlertController;)V
    ...
    .line 992
    iget-boolean v0, p0, Landroid/support/v7/app/AlertController$a;->G:Z
    ...
    .line 1062
    iget v0, p0, Landroid/support/v7/app/AlertController$a;->I:I

    iput v0, p1, Landroid/support/v7/app/AlertController;->k:I

    .line 1064
    iget-object v0, p0, Landroid/support/v7/app/AlertController$a;->x:Landroid/content/DialogInterface$OnClickListener;
    ...
    :cond_1
    :goto_1
    iget-object v0, p0, Landroid/support/v7/app/AlertController$a;->N:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    .line 1092
    :cond_2
    iget-boolean v0, p0, Landroid/support/v7/app/AlertController$a;->H:Z
    ...
    iget-object v3, p0, Landroid/support/v7/app/AlertController$a;->K:Landroid/database/Cursor;

    new-array v7, v9, [Ljava/lang/String;

    iget-object v8, p0, Landroid/support/v7/app/AlertController$a;->L:Ljava/lang/String;
    ...
    .line 1074
    :cond_9
    iget-object v0, p0, Landroid/support/v7/app/AlertController$a;->J:Landroid/content/DialogInterface$OnMultiChoiceClickListener;
...
.method public a(Landroid/support/v7/app/AlertController;)V
    ...
    iget-object v3, p0, Landroid/support/v7/app/AlertController$a;->k:Landroid/content/DialogInterface$OnClickListener;

    iget-object v5, p0, Landroid/support/v7/app/AlertController$a;->j:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/app/AlertController$a;->l:Ljava/lang/CharSequence;

    iget-object v3, p0, Landroid/support/v7/app/AlertController$a;->n:Landroid/content/DialogInterface$OnClickListener;

    iget-object v5, p0, Landroid/support/v7/app/AlertController$a;->m:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/app/AlertController$a;->o:Ljava/lang/CharSequence;

    iget-object v3, p0, Landroid/support/v7/app/AlertController$a;->q:Landroid/content/DialogInterface$OnClickListener;

    iget-object v5, p0, Landroid/support/v7/app/AlertController$a;->p:Landroid/graphics/drawable/Drawable;
    ...
    .line 969
    iget-object v1, p0, Landroid/support/v7/app/AlertController$a;->z:Landroid/view/View;

    iget v2, p0, Landroid/support/v7/app/AlertController$a;->A:I

    iget v3, p0, Landroid/support/v7/app/AlertController$a;->B:I

    iget v4, p0, Landroid/support/v7/app/AlertController$a;->C:I

    iget v5, p0, Landroid/support/v7/app/AlertController$a;->D:I
