...
.method public static parse(Landroid/os/Bundle;)Ltv/danmaku/ijk/media/player/IjkMediaMeta;
    ...
    .line 197
    :cond_0
    new-instance v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;

    invoke-direct {v2}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;-><init>()V

    .line 198
    iput-object p0, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;

    .line 200
    const-string v1, "format"

    invoke-virtual {v2, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mFormat:Ljava/lang/String;

    .line 201
    const-string v1, "duration_us"

    invoke-virtual {v2, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v4

    iput-wide v4, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mDurationUS:J
    ...
    iput-wide v4, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mStartUS:J
    ...
    iput-wide v4, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mBitrate:J

    .line 205
    const-string v1, "video"

    invoke-virtual {v2, v1, v0}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    .line 210
    invoke-virtual {v2, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 222
    new-instance v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

    invoke-direct {v6, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;-><init>(I)V

    .line 223
    iput-object v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mMeta:Landroid/os/Bundle;

    .line 224
    const-string v0, "type"

    invoke-virtual {v6, v0}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mLanguage:Ljava/lang/String;

    .line 226
    iget-object v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;
    ...
    iput-object v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;
    ...
    iput-object v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    .line 234
    const-string v0, "bitrate"

    invoke-virtual {v6, v0}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v0

    int-to-long v8, v0

    iput-wide v8, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mBitrate:J
    ...
    iput v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mWidth:I
    ...
    iput v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mHeight:I
    ...
    iput v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsNum:I
    ...
    iput v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsDen:I
    ...
    iput v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrNum:I
    ...
    iput v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrDen:I
    ...
    iput v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarNum:I
    ...
    iput v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarDen:I

    .line 246
    if-ne v3, v1, :cond_3

    .line 247
    iput-object v6, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mVideoStream:Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

    .line 259
    :cond_3
    :goto_2
    iget-object v0, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;
    ...
    iput v0, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSampleRate:I

    .line 252
    const-string v0, "channel_layout"

    .line 253
    invoke-virtual {v6, v0}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v8

    iput-wide v8, v6, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mChannelLayout:J

    .line 255
    if-ne v4, v1, :cond_3

    .line 256
    iput-object v6, v2, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mAudioStream:Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
